...
const CreatePoint: React.FC = () => {
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        await api.post('points', data).then(response => {
            ...
            if (response.status === 200) {
                ...
                if (failure !== null) {
                    failure.classList.remove('no-show');
                    setTimeout(() => {
    ...
    return (
        <>
            ...
            <div className="no-show success">
                <FiCheckCircle style={{color: '#2FB86E'}}/>
                <h1>Ponto Cadastrado com sucesso!</h1>
            </div>
            <div className="no-show failure">
                <FiXCircle style={{color: 'rgba(200, 0, 0)'}}/>
                <h1>Parece que ocorreu um erro!<br/>Por favo tente novamente </h1>
            </div>
        </>
    );
};
